...
export default function ToolActivityIndicator({ activity }: Props) {
  return (
    <div role="status" aria-live="polite" aria-label={activity} className="flex items-center gap-2 animate-slide-up">
      <div className="flex items-center gap-2 rounded-full border border-[rgba(47,102,229,0.18)] bg-[rgba(255,255,255,0.82)] px-3.5 py-1.5 shadow-[0_12px_24px_rgba(47,102,229,0.08)]">
        <span className="relative flex h-2 w-2">
          ...
          <span aria-hidden="true" className="relative inline-flex h-2 w-2 rounded-full bg-[rgba(47,102,229,0.6)]" />
        </span>
